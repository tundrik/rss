...
func (uc *UseCase) Article(ctx context.Context, personPk string) ([]entity.Article, error) {
    ...
    //
    // TODO: также есть проблема что после первых подписок 
    // пользователю возвращает ранее записанные статьи, 
    // и обновляет эту дату просмотра.
    // при последующик подписках соответственно не вернет ранее записанные статьи
